...
define( 'HAPPYFILES_VERSION', '1.5.1' );
...
define( 'HAPPYFILES_SETTING_SHOW_ID_ON_HOVER', 'happyfiles_show_id_on_hover' );
define( 'HAPPYFILES_SETTING_HIDE_RATING_NOTIFICATION', 'happyfiles_hide_rate_us_notification' );
