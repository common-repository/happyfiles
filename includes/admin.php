...
class Admin {
  ...
  public function admin_notices() {
		...
		$hide_rating_notification = get_option( HAPPYFILES_SETTING_HIDE_RATING_NOTIFICATION, false );

		if ( ! $hide_rating_notification ) {
  ...
  public function admin_init() {
    // Register HappyFiles settings
		...
		register_setting( HAPPYFILES_SETTINGS_GROUP, HAPPYFILES_SETTING_SHOW_ID_ON_HOVER );
		register_setting( HAPPYFILES_SETTINGS_GROUP, HAPPYFILES_SETTING_HIDE_RATING_NOTIFICATION );
  }
  ...
  public function admin_screen_settings() {
    ...
    if ( $pagenow !== 'upload.php' ) {
      return;
		...
		$open_category = isset( $user_category_state[$happyfiles_taxonomy] ) ? $user_category_state[$happyfiles_taxonomy] : false;

		if ( isset( $_GET[Helpers::$taxonomy_name] ) ) {
			$open_category = intval( $_GET[Helpers::$taxonomy_name] );
		}
